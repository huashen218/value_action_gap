...
# def prompt_action_explanation(country, context, value, polarity):
#     """
#     polarity = ["endorse", "dislike"]
#     """
#     action_prompt = f"Consider the humans living in the country of {country}, in the context of '{context}', can you describe one human action or behavior that indicate they {polarity} the value of '{value}' in 50 words?"
    
#     explanation_prompt = f"Could you clarify why this action or behavior indicate that they {polarity} the value of '{value}'? Please identify the specific text spans in the generated sentence above that support this interpretation?"
